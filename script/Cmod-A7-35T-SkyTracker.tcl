...
#
# Cmod-A7-35T-SkyTracker.tcl: Tcl script for re-creating project 'Cmod-A7-35T-XADC'
#
...
#
# 1. This project restoration tcl script (Cmod-A7-35T-SkyTracker.tcl) that was generated.
#
...
set _xil_proj_name_ "Cmod-A7-35T-SkyTracker"
...
set script_file "Cmod-A7-35T-SkyTracker.tcl"
...
set file "[file normalize ${origin_dir}/constraints/CmodA7_SkyTracker.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constraints/CmodA7_SkyTracker.xdc"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tcpg236-1 -flow {Vivado Synthesis 2020} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tcpg236-1 -flow {Vivado Implementation 2020} -strategy "Performance_NetDelay_high" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
