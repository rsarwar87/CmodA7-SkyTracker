...
set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports pi_camera_trigger_in]
set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports pi_camera_trigger_out]
set_property -dict {PACKAGE_PIN G5 IOSTANDARD LVCMOS33} [get_ports pi_pwm_led_in]
set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports {camera_triggers[0]}]
