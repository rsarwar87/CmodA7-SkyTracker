...
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports {PI_SS_N[0]}]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports {PI_SS_N[1]}]
set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS33} [get_ports PI_MOSI]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports PI_MISO]
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { pio[6] }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports {S_LED[0]}]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports {S_LED[1]}]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports {S_LED[2]}]
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports {S_LED[3]}]
set_property -dict {PACKAGE_PIN J1 IOSTANDARD LVCMOS33} [get_ports {S_LED[4]}]
set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports {S_LED[5]}]
set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS33} [get_ports {S_LED[6]}]
set_property -dict {PACKAGE_PIN L2 IOSTANDARD LVCMOS33} [get_ports {S_LED[7]}]
set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { S_LED[8] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { S_LED[9] }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { S_LED[10]         }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { S_LED[11] }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { S_LED[12] }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { S_LED[13] }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
set_property -dict {PACKAGE_PIN P1 IOSTANDARD LVCMOS33} [get_ports led_polar]
set_property -dict {PACKAGE_PIN R3 IOSTANDARD LVCMOS33} [get_ports ra_enable_n]
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports {ra_mode[0]}]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS33} [get_ports {ra_mode[1]}]
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports {ra_mode[2]}]
set_property -dict {PACKAGE_PIN T2 IOSTANDARD LVCMOS33} [get_ports ra_rst_n]
set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports ra_sleep_n]
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVCMOS33} [get_ports ra_step]
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33} [get_ports ra_direction]
set_property -dict {PACKAGE_PIN W3 IOSTANDARD LVCMOS33} [get_ports ra_fault_n]
set_property -dict {PACKAGE_PIN V3 IOSTANDARD LVCMOS33} [get_ports de_enable_n]
set_property -dict {PACKAGE_PIN W5 IOSTANDARD LVCMOS33} [get_ports {de_mode[0]}]
set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports {de_mode[1]}]
set_property -dict {PACKAGE_PIN U4 IOSTANDARD LVCMOS33} [get_ports {de_mode[2]}]
set_property -dict {PACKAGE_PIN V5 IOSTANDARD LVCMOS33} [get_ports de_rst_n]
set_property -dict {PACKAGE_PIN W4 IOSTANDARD LVCMOS33} [get_ports de_sleep_n]
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports de_step]
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports de_direction]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports de_fault_n]
#set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { pio[39] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { pio[40] }]; #IO_L19P_T3_34 Sch=pio[45]
set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports {camera_triggers[1]}]
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { pio[42] }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports {camera_triggers[0]}]
